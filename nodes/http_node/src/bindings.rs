...
pub trait Guest {
    fn execute(params: _rt::String) -> _rt::String;
}
#[doc(hidden)]
...
macro_rules! __export_world_example_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    #[export_name = "execute"]
    unsafe extern "C" fn export_execute(arg0: *mut u8,arg1: usize,) -> *mut u8 {
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6454] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xb81\x01A\x02\x01A\x17\
...
i:http/outgoing-handler@0.2.0\x05\x0e\x01@\x01\x06paramss\0s\x04\0\x07execute\x01\
\x0f\x04\x01\x19component:trigger/example\x04\0\x0b\x0d\x01\0\x07example\x03\0\0\
